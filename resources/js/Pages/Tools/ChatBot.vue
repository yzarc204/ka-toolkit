<template>
  <div class="h-full bg-gray-50 dark:bg-gray-900 flex flex-col p-4 md:p-6">
    <!-- Chat Container -->
    <div
      class="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col min-h-0">
      <!-- Chat Header -->
